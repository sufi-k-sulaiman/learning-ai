...
export default function CookiePolicy() {
    ...
    const cookieTypes = [
        { id: 'essential', icon: Shield, title: 'Essential Cookies', desc: 'Required for basic site functionality. Cannot be disabled.', required: true,
          details: 'These cookies are necessary for the website to function and cannot be switched off. They are usually only set in response to actions made by you, such as setting your privacy preferences, logging in, or filling in forms.' },
        { id: 'analytics', icon: BarChart3, title: 'Analytics Cookies', desc: 'Help us understand how visitors interact with our site.', required: false,
          details: 'These cookies allow us to count visits and traffic sources so we can measure and improve the performance of our site. They help us know which pages are the most and least popular and see how visitors move around the site.' },
        ...
        { id: 'personalization', icon: Settings, title: 'Personalization Cookies', desc: 'Remember your preferences and settings.', required: false,
          details: 'These cookies enable the website to provide enhanced functionality and personalization. They may be set by us or by third party providers whose services we have added to our pages.' },
    ];
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-4xl mx-auto p-6 -mt-16 relative z-10">
                ...
                <Card className="p-6 mb-8 bg-white shadow-lg">
                    ...
                    <p className="text-gray-600 mb-6">Choose which cookies you want to accept. Essential cookies cannot be disabled.</p>
                ...
                <Card className="p-6 bg-white shadow-lg">
                    ...
                    <div className="prose prose-gray max-w-none">
                        <p className="text-gray-600 mb-4">This Cookie Policy explains what cookies are and how we use them. You should read this policy to understand what cookies are, how we use them, the types of cookies we use, and how you can control your cookie preferences.</p>
                        
                        <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-2">What Are Cookies?</h3>
                        <p className="text-gray-600 mb-4">Cookies are small text files that are stored on your computer or mobile device when you visit a website. They are widely used to make websites work more efficiently and to provide information to the owners of the site.</p>
                        
                        <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-2">How Long Do Cookies Last?</h3>
                        <p className="text-gray-600 mb-4">Session cookies are temporary and are deleted when you close your browser. Persistent cookies remain on your device for a set period or until you delete them.</p>
                        
                        <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-2">Your Rights</h3>
                        <p className="text-gray-600">You have the right to decide whether to accept or reject cookies. You can exercise your cookie preferences by using the controls above or through your browser settings.</p>
                    </div>
