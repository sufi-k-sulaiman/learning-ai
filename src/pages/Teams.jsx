...
export default function Teams() {
    ...
    const teamLocations = [
        { country: 'United States', visitors: 45, percentage: 35 },
        { country: 'United Kingdom', visitors: 28, percentage: 22 },
        { country: 'Germany', visitors: 18, percentage: 14 },
        { country: 'Singapore', visitors: 22, percentage: 17 },
        { country: 'Australia', visitors: 15, percentage: 12 },
    ];
