                    ...
                    <div className="space-y-6">
                        <Card className="p-6 bg-white shadow-lg">
                            ...
                            <div className="space-y-4">
                                {[
                                    { icon: Mail, label: 'Email', value: 'support@1cpublishing.com', color: 'bg-purple-100 text-purple-600' },
                                    { icon: Phone, label: 'Phone', value: '+1 (555) 123-4567', color: 'bg-blue-100 text-blue-600' },
                                    { icon: MapPin, label: 'Address', value: '123 Innovation Drive, Tech City, TC 10001', color: 'bg-green-100 text-green-600' },
                                    { icon: Clock, label: 'Hours', value: 'Mon-Fri: 9AM - 6PM EST', color: 'bg-amber-100 text-amber-600' },
                                ].map((item, i) => (
