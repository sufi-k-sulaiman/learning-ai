...
const CATEGORIES = {
  ...
  Living_Things: {
    ...
    items: ["Plants", "Animals", "Microorganisms", "Insects", "Birds", "Fish", "Reptiles", "Humans", "Amphibians", "Fungi", "Mollusks", "Crustaceans", "Arachnids", "Algae", "Dinosaurs", "Ant", "Bee", "Butterfly", "Beetle", "Dragonfly", "Grasshopper", "Mosquito", "Fly", "Wasp", "Termite", "Cricket", "Moth", "Ladybug", "Firefly", "Spider", "Scorpion", "Tick", "Mite", "Crab", "Lobster", "Shrimp", "Krill", "Barnacle", "Octopus", "Squid", "Snail", "Slug", "Clam", "Oyster", "Mussel", "Starfish", "Sea urchin", "Sea cucumber", "Jellyfish", "Coral", "Sea anemone", "Sponge", "Earthworm", "Leech", "Flatworm", "Roundworm", "Shark", "Salmon", "Tuna", "Trout", "Eel", "Ray", "Seahorse", "Frog", "Toad", "Salamander", "Newt", "Snake", "Lizard", "Turtle", "Tortoise", "Crocodile", "Alligator", "Eagle", "Hawk", "Owl", "Penguin", "Parrot", "Sparrow", "Crow", "Raven", "Peacock", "Flamingo", "Duck", "Goose", "Swan", "Pigeon", "Dove", "Bat", "Human", "Dog", "Wolf", "Fox", "Bear", "Elephant", "Giraffe", "Zebra", "Horse", "Cow", "Sheep", "Goat", "Pig", "Deer", "Moose", "Bison", "Buffalo", "Kangaroo", "Koala", "Monkey", "Gorilla", "Chimpanzee", "Orangutan", "Dolphin", "Whale", "Seal", "Walrus", "Otter", "Hedgehog", "Rabbit", "Squirrel", "Mouse", "Rat", "Hamster", "Porcupine", "Raccoon", "Skunk", "Badger", "Wolverine", "Hyena", "Lionfish", "Stingray", "Sea turtle", "Manatee", "Dugong", "Antelope", "Camel", "Llama", "Alpaca", "Panda", "Red panda", "Sloth", "Armadillo", "Anteater", "Platypus", "Echidna"]
  },
  Forces_Cycles: {
    name: "Forces & Cycles",
    icon: Zap,
