...
import {
  ...
  Sparkles, Star, Brain, Award, Loader2, RotateCcw } from
'lucide-react';
        ...
        className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            ...
            style={{ backgroundColor: `${category?.color}15` }}>
                    ...
                    <div className="grid grid-cols-3 gap-3 sm:gap-4 max-w-lg mx-auto mb-8">
                        <div className="bg-gray-50 px-2 py-4 rounded-xl sm:p-6 border border-gray-100">
                        ...
                        <div className="bg-gray-50 px-4 py-4 rounded-xl sm:p-6 border border-gray-100">
